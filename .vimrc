...
let g:ycm_global_ycm_extra_conf = '/home/halfon_m/.ycm_extra_conf.py'
" SuperTab
...
let g:ale_c_gcc_options = '-W -Wall -Wextra -O -Iinclude -Iincludes -Iinc'
let g:ale_c_clang_options = '-W -Wall -Wextra -O -Iinclude -Iincludes -Iinc'
let g:ale_cpp_clang_options = '-W -Wall -Wextra -Iinclude -Iincludes -Iinc -std=c++14'
...
" Epitech
let g:epi_login='michael.halfon@epitech.eu'
let g:epi_name='Michael Halfon'
